...
# (Se retiró `enviar_credenciales_admin`/`_plantilla_credenciales`: enviaba la
#  contraseña EN CLARO por correo. El alta usa `enviar_enlace_alta`, un enlace de
#  un solo uso para que el propio admin cree su contraseña — nunca viaja en claro.)
