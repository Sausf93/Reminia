...
- **Pruebas E2E de escenario** (no son pytest; se ejecutan a mano, SQLite en memoria, NO tocan prod): `backend/api/ecosistema_e2e.py` (3 centros × 5 trabajadoras × 20 personas, 12 salas simultáneas, aislamiento; debe dar 46/0) y `backend/api/e2e_escenario.py` (2 grupos simultáneos, 28/0). Correr tras cambios de sesiones/medición/evolución/auth.
